...
\placefig{3}{1.4}{width=3.5cm}{tsibble.png}
\placefig{6.5}{1.4}{width=3.5cm}{tsibbledata.png}
\placefig{10}{3.4}{width=3.5cm}{feasts.png}
\placefig{12.5}{3.4}{width=3.5cm}{fable.png}

# What does modern time series data look like? (tsibble)
...
--> need to deal with high frequency and multiple seasonalities

Show examples with multiple keys

--> need to deal with collections of time series

Hierarchical and grouping structures

## Storing time series as `tsibble` objects
...
# EDA for large time series (feasts)
...
# Probabilistic forecasting for large time series (fable)
